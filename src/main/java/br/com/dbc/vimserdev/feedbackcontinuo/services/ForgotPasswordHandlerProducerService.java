...
public class ForgotPasswordHandlerProducerService {

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final ObjectMapper mapper;

    @Value("${cloudkarafka.forgotpass.topic}")
    private String topic;

    public void send(ForgotPasswordHandlerDTO forgotPasswordHandlerDTO) throws JsonProcessingException {
        this.send(mapper.writeValueAsString(forgotPasswordHandlerDTO));
    }
